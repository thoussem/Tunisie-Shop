			...
			<header class="col-xs-12 prime">
				...
				<div classe="table">
					<div class="wrap">
						...
						<div class="rowtitle">
							<span class="nom">Nom du produit</span>
				...
				<div class="row">
							<a href="#" class="img"><img src="../wp-content/uploads/2013/01/<?= $produit->id; ?>.jpg" width=10% height=10%></a>
							<span class="nom"><?= $produit->nom ; ?></span>
							<span class="prix">&euro;<?= number_format($produit->prix,3,',',' ') ; ?></span>
							<span class="qte"><?= $_SESSION['panier'][$produit->id]; ?></span>
							<span class="total">Total</span>
							<span class="action">
							<a href="panier.php?del= <?= $produit->id; ?>" class="del"><img src="../wp-content/uploads/2013/01/p.jpg" width=3% height=3%></a>
							</span>
							<span>&euro;</span>
						</div>
					<?php endForeach; ?>
