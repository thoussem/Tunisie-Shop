...
<!-- ============== -->
	...
	<div class="row">
		<div id="flexslider" class="flexslider col-12">
		  <ul class="slides">
		  	<li><img src="../wp-content/uploads/2013/01/masthead11.jpg" alt="Fifth Slider" /></li><li><a href="#"><img src="../wp-content/uploads/2013/01/banner-b.jpg" alt="First Slider" /></a></li><li><img src="../wp-content/uploads/2013/01/masthead21.jpg" alt="Sixth Slider" /></li><li><img src="../wp-content/uploads/2013/01/banner-c.jpg" alt="Second Slider" /><p class="flex-caption"><strong>Leatherman</strong><br />
You can simply put any caption here <br /><br />
<a class="btn theme">BUY</a></p></li><li><a href="#"><img src="../wp-content/uploads/2013/01/banner-e.jpg" alt="Third Slider" /></a></li><li><img src="../wp-content/uploads/2013/01/banner-d.jpg" alt="Fourth Slider" /></li>		  </ul>
		</div>
	</div>
...
<!-- ======== -->
	...
	<div class="row">
		<div class="carousel-option col-12">
			<div id="flexcarousel" class="flexslider">
				...
				<li><img src="../wp-content/uploads/2013/01/masthead11.jpg" alt="Fifth Slider" /></li><li><img src="../wp-content/uploads/2013/01/banner-b.jpg" alt="First Slider" /></li><li><img src="../wp-content/uploads/2013/01/masthead21.jpg" alt="Sixth Slider" /></li><li><img src="../wp-content/uploads/2013/01/banner-c.jpg" alt="Second Slider" /></li><li><img src="../wp-content/uploads/2013/01/banner-e.jpg" alt="Third Slider" /></li><li><img src="../wp-content/uploads/2013/01/banner-d.jpg" alt="Fourth Slider" /></li>	
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-xs-12">	
					...
					<div class="row">
						...
						<h5 class="brands"><strong>PRODUITS VEDETTES</strong></h5>
		...
		<!-- Sale -->
				...
				<!-- Thumbnail -->
						<img src="../wp-content/uploads/2013/01/194809_mrp_in_l.jpg" data-at2x="http://thehumblespace.com/wp/humbleshop/wp-content/uploads/2013/01/194809_mrp_in_l.jpeg" alt="Simple Kinky Shirt"/>
							<div class="mask">
			<h2 class="maskprice">
				<span class="amount">&pound;98.00</span>			</h2>
			<form class="cart" method="post" enctype='multipart/form-data'>
				<p>In pellentesque faucibus vestibulum. Nulla at nulla justo, eget luctus tortor. N..</p>										
						<a href="../shop/simple-kinky-shirt/index.html" class="btn btn-sm custom">View</a> 
	...
	<p class="product-title">
		<a href="../shop/simple-kinky-shirt/index.html">Simple Kinky Shirt</a>
			</p>
...
<footer>
	<div class="container">
		<section class="row foot">
			...
			<article id="nav_menu-2" class="col-sm-3 widget_nav_menu"><strong class="title">Liens Rapides</strong><div class="menu-footer-container"><ul id="menu-footer" class="menu"><li id="menu-item-137" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-137"><a href="#">A Propos De Nous</a></li>
...
<li id="menu-item-141" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-141"><a href="../contact-us/index.html">Contact</a></li>
					...
					<article id="recent-posts-5" class="col-sm-3 widget_recent_entries">		<strong class="title">DERNIERS POSTES</strong>		<ul>
					<li>
