...
<article class="col-sm-3">
 <strong class="title">NOTRE EMPLACEMENT</strong>
 <address class="row ">
  <div class="col-xs-2"><i class="fa fa-map-marker"></i></div>
  <div class="col-xs-10">
   45 Rue des Entrepreneurs<br />Charguia2<br />Tunis<br /></div>
</address>
<address class="row ">
...
<address class="row ">
   ...
   <div class="col-xs-10"><a href="mailto:tunisieShop2015@gmail.com">tunisieShop2015@gmail.com</a></div>
</address>
</article>
