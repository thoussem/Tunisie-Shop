		...
		<div class="row">		
			<div class="col-12">
				<nav class="horizontal-nav full-width">
					<ul id="nav" class="nav hidden-xs"><li id="menu-item-218" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-218"><a href="../homepage-with-carousel/index.php">Acceuil</a>
<ul class="nav">
	<li id="menu-item-217" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-214 current_page_item menu-item-217"><a href="../homepage-with-carousel/index.php">Homepage Carousel</a></li>
</ul>
</li>
<li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-25"><a href="../shop/index.html">BOUTIQUE</a>
<ul class="nav">
...
<!-- ============ -->
	...
	<div class="row">
			...
			<div class="col-sm-4 hidden-xs">
				<div class="sidebar">
					<aside id="woocommerce_widget_cart-3" class="widget woocommerce widget_shopping_cart"><p class="title">Cart</p><div class="widget_shopping_cart_content"></div></aside><aside id="woocommerce_price_filter-3" class="widget woocommerce widget_price_filter"><p class="title">Filter by price</p><form method="get" action="http://thehumblespace.com/wp/humbleshop/shop">
		...
		</form></aside><aside id="woocommerce_layered_nav-2" class="widget woocommerce widget_layered_nav"><p class="title">Layered Navigation</p><ul><li ><a href="index9fb1.html?filter_size=20">Extra Large</a> <span class="count">(2)</span></li><li ><a href="index1938.html?filter_size=19">Large</a> <span class="count">(2)</span></li><li ><a href="indexb7ab.html?filter_size=18">Medium</a> <span class="count">(2)</span></li><li ><a href="index1d93.html?filter_size=17">Small</a> <span class="count">(2)</span></li></ul></aside>				</div>
			</div>
	...
	<div class="col-xs-6 woocommerce-result-count text-left">
	...
	<p class="product-title">
		<a href="blues-denim/index.html">Blues Denim</a>
			</p>
		...
		<!-- Sale -->
			...
			<form class="cart" method="post" enctype='multipart/form-data'>
				<p>Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl t..</p>										
						<a href="cafe-racer-jacket/index.html" class="btn btn-sm custom">View</a> 
	...
	<p class="product-title">
		<a href="cafe-racer-jacket/index.html">Cafe Racer Jacket</a>
			</p>
		...
		<!-- Sale -->
			...
			<form class="cart" method="post" enctype='multipart/form-data'>
				<p>Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl t..</p>				<a href="leather-sling-track/index.html" rel="nofollow" data-product_id="80" class="btn btn-sm add_to_cart_button product_type_variable custom">Select</a>	
							</form>
		</div>
	</div>
	<p class="product-title">
		<a href="leather-sling-track/index.html">Leather Sling Track</a>
			</p>
		...
		<!-- Sale -->
			...
			<form class="cart" method="post" enctype='multipart/form-data'>
				<p>Nulla at nulla justo, eget luctus tortor. Nulla facilisi. Duis aliquet egestas p..</p>										
						<a href="mahogany-footprint/index.html" class="btn btn-sm custom">View</a> 
	...
	<p class="product-title">
		<a href="mahogany-footprint/index.html">Mahogany Footprint</a>
			</p>
		...
		<!-- Sale -->
			...
			<form class="cart" method="post" enctype='multipart/form-data'>
				<p>Nulla facilisi. Duis aliquet egestas purus in blandit. Curabitur vulputate, ligu..</p>										
						<a href="moscot-crowbar/index.html" class="btn btn-sm custom">View</a> 
	...
	<p class="product-title">
		<a href="moscot-crowbar/index.html">Moscot Crowbar</a>
			</p>
		...
		<!-- Sale -->
			...
			<form class="cart" method="post" enctype='multipart/form-data'>
				<p>Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl t..</p>										
						<a href="radiohead-pocket/index.html" class="btn btn-sm custom">View</a> 
	...
	<p class="product-title">
		<a href="radiohead-pocket/index.html">Radiohead Pocket</a>
			</p>
	...
	<p class="product-title">
		<a href="red-garage/index.html">Red Garage</a>
			</p>
		...
		<!-- Sale -->
			...
			<form class="cart" method="post" enctype='multipart/form-data'>
				<p>Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl t..</p>				<a href="ripped-jeans/index.html" rel="nofollow" data-product_id="91" class="btn btn-sm add_to_cart_button product_type_variable custom">Select</a>	
							</form>
		</div>
	</div>
	<p class="product-title">
		<a href="ripped-jeans/index.html">Ripped Jeans</a>
			</p>
	...
	<p class="product-title">
		<a href="rough-sunset-jacket/index.html">Rough Sunset Jacket</a>
			</p>
...
<div class="shoptop bottom row">
	...
	<div class="col-sm-3 text-right">
		<a href="page/2/index.html" ><div class="btn btn-sm btn-default theme">Next <span class="meta-nav">&rarr;</span></div></a>	</div>
</div>
					</div>
