...
<html lang="en-US">
   ...
   <head>
      ...
      <link rel="alternate" type="application/rss+xml" title="HumbleShop &raquo; Contact Comments Feed" href="feed/index.html" />
      ...
      <meta property="og:url" content="http://thehumblespace.com/wp/humbleshop/contact-us/" />
   ...
   <body class="page page-id-42 page-template page-template-contact page-template-contact-php wf-active">
      <!-- ====== -->
      <!-- TOPBAR -->
      <!-- ====== -->
                  ...
                  <div class="col-sm-4">
                     <div class="wrap contactform">
                        <address class="row ">
                           ...
                           <div class="col-xs-10">
                              45 Rue des Entrepreneurs<br />Charguia2<br />Tunis<br />
                        </address>
                        <address class="row ">
                        <div class="col-xs-2"><i class="fa fa-phone"></i></div>
                        <div class="col-xs-10">+216 71222222</div>
                        </address>
                        <address class="row ">
                        ...
                        <div class="col-xs-10"><a href="mailto:hello@humbleshop.com">tunisieShop2015@gmail.com</a></div>
                        </address>
                        </div>
                     </div>
                     <!-- Content -->
                           ...
                           <div class="wpcf7" id="wpcf7-f176-p42-o1" dir="ltr">
                              ...
                              <form name="" action="index.php" method="post" class="wpcf7-form" novalidate="novalidate">
                                 <div style="display: none;">
                                    ...
                                    <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f176-p42-o1" />
                                    <input type="hidden" name="_wpnonce" value="71e79c83aa" />
                                 </div>
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <label>Nom</label><br />
   ...
   <!-- Mirrored from thehumblespace.com/wp/humbleshop/contact-us/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Apr 2015 22:18:19 GMT -->
</html>